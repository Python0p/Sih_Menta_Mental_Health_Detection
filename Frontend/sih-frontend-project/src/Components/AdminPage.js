...
// function AdminPage() {
//   return (
//     <div className="min-h-screen bg-gray-700 p-5 flex flex-col">
//       {/* Left Div for Doctor Details */}
...
//           <p>Doctor ID: DR12345</p>
//         </div>
//         <h2 className="text-2xl font-semibold mb-2">Doctor Table</h2>
//         {/* <table className="table-auto text-white">
//           <thead>
//             <tr>
//               <th className="px-4 py-2">ID</th>
...
//             <tr>
//               <td className="border px-4 py-2">1</td>
//               <td className="border px-4 py-2">Doctor 1</td>
//               <td className="border px-4 py-2">40</td>
//               <td className="border px-4 py-2">doctor1@example.com</td>
//               <td className="border px-4 py-2">Good</td>
//             </tr>
//             <tr>
//               <td className="border px-4 py-2">2</td>
//               <td className="border px-4 py-2">Doctor 2</td>
//               <td className="border px-4 py-2">45</td>
//               <td className="border px-4 py-2">doctor2@example.com</td>
//               <td className="border px-4 py-2">Excellent</td>
//             </tr>
//             <tr>
//               <td className="border px-4 py-2">3</td>
//               <td className="border px-4 py-2">Doctor 3</td>
//               <td className="border px-4 py-2">38</td>
//               <td className="border px-4 py-2">doctor3@example.com</td>
